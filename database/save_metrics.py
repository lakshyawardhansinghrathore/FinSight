...
def save_metrics(
    ...
    params = {
        ...
        "risk_factors": _to_str(metrics.get("Top Risk Factors") or metrics.get("risk_factors")),
        "growth_drivers": _to_str(metrics.get("Top Growth Drivers") or metrics.get("growth_drivers")),
    }
